...
public class NetworkSpeedNextModule extends ReactContextBaseJavaModule implements LifecycleEventListener {

  private final ReactApplicationContext reactContext;
  private NetworkSpeedTimer mNetworkSpeedTimer;

  public NetworkSpeedNextModule(ReactApplicationContext reactContext) {
    super(reactContext);
